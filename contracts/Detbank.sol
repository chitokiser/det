...
import "/.def"  //def
    ...
    constructor(Det _det,Def _def)public {
       det=_det;
       def=_def;
       tvl=500000000 //5억 det
    }
    ...
    function depoout( )public {
      ...
      uint256 memory pay=myinfo[msg.sender].depo*(now-myinfo[msg.sender].depot)+550/600;  //1day변환 코딩필요
